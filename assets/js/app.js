...
import { $, $$, el, fmtNum, md2html, closeDrawer, openDrawer, field, actions, toast } from './ui.js?v=13';
import { store, featuredOf, placeholder } from './store.js?v=13';
import { PLATFORMS } from './social.js?v=13';
import * as admin from './admin.js?v=13';
import { trackVisit } from './analytics.js?v=13';
...
async function init() {
  ...
  // 访客埋点：放在最后且自带 try/catch + 空闲调度，任何失败都不影响页面
  try { trackVisit(); } catch (_) { /* ignore */ }
}
