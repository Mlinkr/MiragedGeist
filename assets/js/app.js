...
import { $, $$, el, fmtNum, md2html, closeDrawer, openDrawer, field, actions, toast } from './ui.js?v=2';
import { store, featuredOf, placeholder } from './store.js?v=2';
import { PLATFORMS } from './social.js?v=2';
